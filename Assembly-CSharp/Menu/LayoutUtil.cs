...
namespace Modding.Menu
{
    ...
    public struct AnchoredPosition
    {
        ...
        {
            Vector2 childAnchorDiff = (child.anchorMax - child.anchorMin);
            Vector2 product = new Vector2(childAnchorDiff.x * childPoint.x, childAnchorDiff.y * childPoint.y);
            return child.anchorMin + product;
        }
    ...
    public struct RelVector2
    {
        ...
        public static RelVector2 operator *(RelVector2 lhs, Vector2 rhs) => new RelVector2(
            new Vector2(lhs.Delta.x * rhs.x,lhs.Delta.y * rhs.y),
             new Vector2(lhs.Relative.x * rhs.x,lhs.Relative.y * rhs.y)
        );
        /// <summary>
