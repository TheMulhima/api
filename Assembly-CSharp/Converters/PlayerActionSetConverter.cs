        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            while (reader.TokenType == JsonToken.PropertyName)
            {
                ...
                if (ac != null)
                {
                    ...
                    {
                        if (val == new Patches.InputHandler.KeyOrMouseBinding().ToString() || val == InputControlType.None.ToString())
                        {
                            ac.ClearBindings();
                        }
                        else if (KeybindUtil.ParseBinding(val) is Patches.InputHandler.KeyOrMouseBinding bind)
                        {
                            ac.ClearBindings();
